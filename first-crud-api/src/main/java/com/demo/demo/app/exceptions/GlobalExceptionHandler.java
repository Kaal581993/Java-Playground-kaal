package com.demo.demo.app.exceptions;
...
//Global Exception Handler
    ...
    @ExceptionHandler({HttpClientErrorException.class, HttpServerErrorException.class, MethodArgumentNotValidException.class,
            StreamConstraintsException.class, SQLIntegrityConstraintViolationException.class, HttpMessageNotReadableException.class,
